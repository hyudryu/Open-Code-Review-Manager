...
def build_mcp_server() -> FastMCP:
    ...
    mcp.tool(
        ...
        description=(
            ...
            "SECURITY: command/args/setup/env are persisted to the OCR user "
            "config and later executed by the OCR binary on this machine "
            "with the user's privileges. Only add servers the user "
            "explicitly asked for, and confirm the exact command/setup with "
            "them when they were not spelled out in the request.\n\n"
